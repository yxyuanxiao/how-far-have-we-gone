...
deepspeed --include localhost:$1 --master_port 6682 src/train/train_mem.py \
    ...
    --data_paths ./data_preprocess/train/train_Semantics.json \
    --data_weights 1 \
    --image_folder ../data \
    --output_dir ./checkpoints/deqa_lora_semantics \
