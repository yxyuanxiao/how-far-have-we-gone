...
def main(args):
    ...
    inp = "How would you rate the quality of this image?" if args.prompt is None else args.prompt
    print(f"Using prompt: {inp}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt", type=str, default=None,
                        help="Custom question prompt; defaults to the generic quality question.")
